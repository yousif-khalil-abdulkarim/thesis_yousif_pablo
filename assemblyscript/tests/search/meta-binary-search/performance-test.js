...
const fileNames = readdirSync("./tests/performance/meta-binary-search")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/performance/meta-binary-search"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/performance/meta-binary-search/${fileName}.html`),
