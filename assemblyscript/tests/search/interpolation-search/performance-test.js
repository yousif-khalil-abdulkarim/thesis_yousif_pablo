...
const fileNames = readdirSync("./tests/performance/interpolation-search")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/performance/interpolation-search"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/performance/interpolation-search/${fileName}.html`),
