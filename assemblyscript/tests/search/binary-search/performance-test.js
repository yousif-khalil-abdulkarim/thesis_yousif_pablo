...
const fileNames = readdirSync("./tests/search/binary-search")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/search/binary-search"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/search/binary-search/${fileName}.html`),
