...
const fileNames = readdirSync("./tests/performance/quick-sort")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/performance/quick-sort"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/performance/quick-sort/${fileName}.html`),
