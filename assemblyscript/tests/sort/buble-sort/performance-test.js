...
const fileNames = readdirSync("./tests/performance/buble-sort")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/performance/buble-sort"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/performance/buble-sort/${fileName}.html`),
