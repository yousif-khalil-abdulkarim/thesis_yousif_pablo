...
const fileNames = readdirSync("./tests/performance/merge-sort")
...
for (const fileName of fileNames) {
  await withCsv(resolve("./tests/performance/merge-sort"), fileName, async (csv) => {
    /**
     * @type{Omit<import("../../performance-test-helper.js").IExcuteOptions, "browser">}
     */
    const settings = {
      filePath: resolve(`./tests/performance/merge-sort/${fileName}.html`),
